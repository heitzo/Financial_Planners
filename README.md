...
## Part 1 Overview: Create a Financial Planner for Emergencies
In this section, you’ll create a personal financial planner for emergencies. To develop the prototype, assume the following:
The average monthly household income for each credit union member is 12000
...
## Part 2 Overview: Create a Financial Planner for Retirement
...
4. Answer the following questions in your Jupyter notebook
...
2. Evaluate the Stock and Bond Holdings by Using the Alpaca SDK
    ...
    3. Set the following parameters for the Alpaca API call:
        a. tickers: Use the tickers for the member’s stock and bond holdings.
        b. timeframe: Use a time frame of one day.
        c. start_date and end_date: Use the same date for these parameters, and format them with the date of the previous weekday (or 2020-08-07). This is because you want the one closing price for the most-recent trading day.
...
3. Evaluate the Emergency Fund
    ...
    2. Use the savings_data list to create a Pandas DataFrame named savings_df, and then display this DataFrame. The function to create the DataFrame should take the following three parameters:
        a. savings_data: Use the list that you just created.
        b. columns: Set this parameter equal to a Python list with a single value called amount.
        c. index: Set this parameter equal to a Python list with the values of crypto and stock/bond.
    3. Use the savings_df DataFrame to plot a pie chart that visualizes the composition of the member’s portfolio. The y-axis of the pie chart uses amount. Be sure to add a title.
    4. Using Python, determine if the current portfolio has enough to create an emergency fund as part of the member’s financial plan. Ideally, an emergency fund should equal to three times the member’s monthly income. To do this, implement the following steps:
    5. Create a variable named emergency_fund_value, and set it equal to three times the value of the member’s monthly_income of 12000. (You set this earlier in Part 1)
    6. Create a series of three if statements to determine if the member’s total portfolio is large enough to fund the emergency portfolio:
...
3. Forecast Cumulative Returns in 10 Years
    ...
    For this new Monte Carlo simulation, do the following:
        ...
        5. Using the current value of only the stock and bond portion of the member's portfolio and the summary statistics that you generated from the new Monte Carlo simulation, what are the lower and upper bounds for the expected value of the portfolio (with the new weights) with a 95% confidence interval?
        6. Will weighting the portfolio more heavily toward stocks allow the credit union members to retire after only 10 years?
